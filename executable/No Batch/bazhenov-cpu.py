...
scale = int(input("Enter Scale (Default = 1 (x120) neurons) : ") or "1") # simulation scale

sim_time = float(input("Enter Time in ms (Default = 1000) : ") or "1000") # simulation time

sim_res = float(input("Enter Time Resolution in ms (Default = 0.01) : ") or "0.01") # simulation resolution
...
n_batch = int(input("Enter Batch Count (Default = 10) :") or "10")
