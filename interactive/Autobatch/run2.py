...
p_0 = [0.1]*n_syn_ach+[0.1]*n_syn_fgaba
p_tau = [15000]*n_syn_ach+[13000]*n_syn_fgaba
del_p = [0]*n_syn_ach+[5]*n_syn_fgaba
...
if sys.argv[1] == '0':
    state_vector =  [-70]* n_n + [0.0]* n_n + [0.0]* (4*p_n) + [0.0]* (3*l_n) + [2.4*(10**(-4))]*l_n + [0]*(n_syn_ach) + [0]*(n_syn_fgaba) + [0.1]*(n_syn_ach) + [0.1]*(n_syn_fgaba) +  [-(sim_time+1)]*n_n
